...
<!-- gen:methods-version -->**Version 0.5** · reader edition · applies to the release built from the 2026-09-21 snapshot<!-- /gen:methods-version -->
...
All companion tables are listed in `checksums.sha256` under the existing release contract. The map's files, and the two JavaScript libraries it loads, are listed in `site/checksums.sha256`.
